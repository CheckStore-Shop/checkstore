...
@Table(value = CommonConstants.EntityName.ROLE)
...
//    protected Long id;
    ...
    public Role(Long id, String name, String description, Integer status, Set<Authority> authorities,
                Set<RoleUserRef> userRefs, Set<RoleAuthorityRef> authorityRefs){
        this.id = id;
        this.name = name;
